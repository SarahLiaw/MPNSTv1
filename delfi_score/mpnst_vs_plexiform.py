...
z_score_path = '/home/sarahl/PycharmProjects/MPNST_v1/delfi_score/data/arm_frag_rm2_otlr.csv'
ratio_path = '/home/sarahl/PycharmProjects/MPNST_v1/delfi_score/data/delfi_diagnosis_rm2otlr.csv'
...
mpnst_plex_df = mpnst_plex_df[(mpnst_plex_df['Diagnosis'] == 'plexiform') | (mpnst_plex_df['Diagnosis'] == 'mpnst')]
...
with open('results/mplx_delfi.csv', 'w', newline='') as f:
    w = csv.writer(f)

    w.writerow(['library', 'DELFI score (plexiform=1, mpnst=0)'])
